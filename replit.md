...
- **Email Verification Redirect Issue (January 2025)**: Email confirmation redirects to home page instead of welcome page. Signup flow correctly sets `emailRedirectTo: /signup-complete` but Supabase configuration may need production domain updates in dashboard redirect URLs.
