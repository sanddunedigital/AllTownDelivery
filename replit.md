...
- **Enhanced Username System (January 2025)**: Improved business signup UX with intelligent username generation. System now creates usernames from owner's first initial + last name (e.g., "Sarah Johnson" → "sjohnson") instead of business name format. Added optional custom username field allowing users full control over their admin login credentials. This provides more professional, memorable usernames while maintaining user flexibility.
